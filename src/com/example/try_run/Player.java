...
public class Player {
	...
	private LightImage playerImg;

	private Map map;

	public Player(int x, int y, LightImage img, Map map) {
		this.playerImg = img;
...
//			}
			...
			g.drawImage(this.playerImg, this.x + offsetX, this.y + offsetY,
					32, 32, this.count * 20, this.dir * 20,
					this.count * 20 + 20, this.dir * 20 + 20, paint);
//			if (!g.isAlpha()) {
...
//			}
			...
			g.drawImage(this.playerImg, this.x + offsetX, this.y + offsetY,
					32, 32, this.count * 20, this.dir * 20,
					this.count * 20 + 20, this.dir * 20 + 20, null);
		}
